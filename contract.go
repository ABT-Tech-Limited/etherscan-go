...
func (c *client) GetContractABI(ctx context.Context, req GetContractABIReq) (resp *StringResp, err error) {
...
func (c *client) GetContractSourceCode(ctx context.Context, req GetContractSourceCodeReq) (resp *ContractSourcecodeResp, err error) {
	params := CopyMap(contractModuleParams)
...
func (c *client) GetContractCreatorTxInfo(ctx context.Context, req GetContractCreatorTxInfoReq) (resp *ContractCreatorTxInfoResp, err error) {
	params := CopyMap(contractModuleParams)
...
func (c *client) VerifySourceCode(ctx context.Context, req VerifySourceCodeReq) (resp *VerifySourceCodeResp, err error) {
	params := CopyMap(contractModuleParams)
...
func (c *client) CheckVerifyStatus(ctx context.Context, req CheckVerifyStatusReq) (resp *StringResp, err error) {
	params := CopyMap(contractModuleParams)
